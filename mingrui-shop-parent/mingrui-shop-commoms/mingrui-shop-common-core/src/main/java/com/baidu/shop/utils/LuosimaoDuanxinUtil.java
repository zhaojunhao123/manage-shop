...
public class LuosimaoDuanxinUtil {
    //短信平台的APIkey
    private static final String DUANXIN_API_KEY = "key-fe5cea719f17e99ff73a9b8a34c536c0";//需要使用自己的APIkey
    private static final String SPEAK_API_KEY = "key-d3b6fdfd074b23897e07d1cd5a93162f";//需要使用自己的APIkey
